...
public class CloudStorageConverter {
    ...
    private AccountMapping accountMappingRequestToAccountMapping(AccountMappingBase accountMappingRequest) {
        ...
        if (accountMappingRequest != null) {
            ...
            accountMapping.setGroupMapping(new HashMap<>(accountMappingRequest.getGroupMapping()));
            accountMapping.setUserMapping(new HashMap<>(accountMappingRequest.getUserMapping()));
        }
    ...
    private AccountMappingBase accountMappingToAccountMappingRequest(AccountMapping accountMapping) {
        ...
        if (accountMapping != null) {
            ...
            accountMappingRequest.setGroupMapping(new HashMap<>(accountMapping.getGroupMapping()));
            accountMappingRequest.setUserMapping(new HashMap<>(accountMapping.getUserMapping()));
        }
